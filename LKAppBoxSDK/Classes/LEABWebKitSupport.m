...
@implementation LEABWebKitSupport

+ (instancetype)sharedSupport {
    
    static LEABWebKitSupport *_instance;
    
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        
        _instance = [LEABWebKitSupport new];
    });
...
@end
@implementation NSHTTPCookie (ABUtils)
...
@implementation ABWeakScriptMessageDelegate
...
@implementation WKWebView (ABCrashHandle)
