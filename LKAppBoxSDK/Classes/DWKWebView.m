...
-(instancetype)initWithFrame:(CGRect)frame configuration:(WKWebViewConfiguration *)configuration
{
    ...
    WKUserScript *script = [[WKUserScript alloc] initWithSource:@"window._lkwk=true;"
    ...
    [self addJavascriptObject:interalApis namespace:@"_lkb"];
    return self;
}
